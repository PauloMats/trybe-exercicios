...
//função para comparar e rornatar a maior not
const maiorNota = (maior, nota) => ((maior > nota) ? maior : nota);

const notasEstudantes = estudantes.map((estudante) estudante.materias.nota);
